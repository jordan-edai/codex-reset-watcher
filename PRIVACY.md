...
The app displays plan type, rate-limit window percentages, reset timing, and reset-credit expiry data returned by Codex. That data stays in the running app process and is not written to disk by Codex Reset Watcher.
